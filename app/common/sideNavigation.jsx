...
import { Home, WalletCards, Award, Settings } from 'lucide-react';
...
const SideNavigation = () => {
  ...
  const navItems = [
    ...
    { href: '/dashboard/points', icon: Award, label: 'Points' },
  ...
  return (
    <nav className="hidden md:flex h-screen w-64 bg-[#333333] fixed left-0 top-0 flex-col">
      ...
      <div className="flex items-center pt-8 px-6">
        ...
        <span className="text-xl font-bold text-white">Lanche_AI</span>
      </div>
